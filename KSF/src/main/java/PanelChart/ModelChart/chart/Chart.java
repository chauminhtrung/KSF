package PanelChart.ModelChart.chart;
...
import PanelChart.ModelChart.chart.blankchart.BlankPlotChart;
import PanelChart.ModelChart.chart.blankchart.BlankPlotChatRender;
import PanelChart.ModelChart.chart.blankchart.SeriesSize;
...
public class Chart extends javax.swing.JPanel {
		...
		blankPlotChart.setBlankPlotChatRender(new BlankPlotChatRender() {
			...
			public void renderSeries(BlankPlotChart chart, Graphics2D g2, SeriesSize size, int index) {
				...
				for (int i = 0; i < legends.size(); i++) {
					...
					int s = seriesSize / 2;
					int sy = seriesSize / 3;
					int px[] = { (int) (size.getX() + x), (int) (size.getX() + x + s), (int) (size.getX() + x + s),
							(int) (size.getX() + x) };
					...
					GradientPaint gra = new GradientPaint((int) (size.getX() + x) - s, 0, legend.getColorLight(),
							(int) (size.getX() + x + s), 0, legend.getColor());
					g2.setPaint(gra);
					g2.fillPolygon(px, py, px.length);
					int px1[] = { (int) (size.getX() + x + s), (int) (size.getX() + x + seriesSize),
							(int) (size.getX() + x + seriesSize), (int) (size.getX() + x + s) };
					int py1[] = { (int) (size.getY() + size.getHeight() - seriesValues + sy),
					...
					int px2[] = { (int) (size.getX() + x), (int) (size.getX() + x + s),
							(int) (size.getX() + x + seriesSize), (int) (size.getX() + x + s) };
					int py2[] = { (int) (size.getY() + size.getHeight() - seriesValues),
							(int) (size.getY() + size.getHeight() - seriesValues - sy),
							(int) (size.getY() + size.getHeight() - seriesValues),
							(int) (size.getY() + size.getHeight() - seriesValues + sy) };
	...
	private void initComponents() {
		...
		blankPlotChart = new PanelChart.ModelChart.chart.blankchart.BlankPlotChart();
	...
	private PanelChart.ModelChart.chart.blankchart.BlankPlotChart blankPlotChart;
