...
@Override
    protected void paintComponent(Graphics g) {
        ...
        // Màu đậm và màu nhạt
        Color startColor = Color.decode("#00003f");//dark blue
        Color endColor = Color.decode("#0000d8");//blue

        // Gradient màu sắc từ trái sang phải
        GradientPaint gradient = new GradientPaint(0, 0, startColor, width, 0, endColor);
        g2d.setPaint(gradient);

        // Vẽ một hình chữ nhật với gradient màu sắc
